export const ARCHITECTURE_LAYERS = [
  ...
  },
  {
    ...
    name: 'Agent Layer',
    status: 'prototype',
    responsibility: 'intent parsing, session-linked planning, read-only analysis execution, tool allowlist, structured summaries, and approval-gated action requests',
