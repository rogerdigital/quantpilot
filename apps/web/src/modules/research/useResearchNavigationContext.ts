...
export function useResearchNavigationContext(
  ...
  return {
    ...
    openStrategyDetail(strategyId: string, options?: { timelineId?: string }) {
      navigate(buildDeepLink('/strategies', {
        strategy: strategyId,
    ...
    openBacktestDetail(runId: string, options?: { strategyId?: string; timelineId?: string; source?: string }) {
    ...
    openExecutionDetail(planId: string, options?: { strategyId?: string; runId?: string; timelineId?: string; source?: string }) {
