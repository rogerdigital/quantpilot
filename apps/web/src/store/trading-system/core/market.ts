...
import {
  applyQuotePatch as sharedApplyQuotePatch,
  createInitialStockStates as sharedCreateInitialStockStates,
  createTickerState as sharedCreateTickerState,
  scoreStock as sharedScoreStock,
  updateTicker as sharedUpdateTicker,
